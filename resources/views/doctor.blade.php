        ...
        <div class="container">
            ...
            <div class="content_space">
                <div class="header">
                    ...
                    <div class="header_title">{{ $doctor->name }} <span style="color: #626DFF">{{ $doctor->specialization }}</span></div>
