...
@section('content')
    <div class="wrapper">
        <div class="container">
            <div class="content_space">
                <a href="{{ route('injections') }}" class="back">
                ...
                <div class="form_container">
                    <form action="{{ route('create_injection') }}" method="POST" autocomplete="off">
                        @csrf
    ...
    <script>
        $('#injections').addClass('sidebar_menu_button_active');
    </script>
@endsection
