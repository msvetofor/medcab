            ...
            <div class="form-container">
                ...
                <form action="{{ route('appointment_create') }}" method="POST" autocomplete="off">
                    ...
                    <div id="specialist" class="form-item">
                        ...
                        <select type="text" id="field-specialist" name="specialist">
                    ...
                    <div id="communication-method" class="form-item">
                        ...
                        <div class="radio-buttons-container">
                            <input type="radio" id="audio-method" name="method-radio-button" value="audio">
                            <input type="radio" id="video-method" name="method-radio-button" value="video">
                            <input type="radio" id="chat-method" name="method-radio-button" value="chat" checked="checked">
    ...
    <style>
        *, *:before, *:after {
        ...
        .appointment {
            ...
            justify-content: center;
            align-items: center;
            font-family: 'Fira Sans'; /* !!!!!!!!!!! это нужно заменить на Fira Sans */
        }
        ...
        .c-m-radio-button svg path {
            stroke: #858AD4;
        }

        .c-m-radio-button span {
            font-size: 18px;
            font-weight: bold;
            color: #858AD4;
            margin-left: 10px;
        ...
        #audio-method:checked ~ #c-m-exception-radio-button-1 svg path {
            stroke: white;
            fill: white;
        }

        #audio-method:checked ~ #c-m-exception-radio-button-1 {
            background-color: #858AD4;
        }

        #audio-method:checked ~ #c-m-exception-radio-button-1 span {
            color: white;
        }

        #video-method:checked ~ #c-m-exception-radio-button-2 svg path {
            stroke: white;
            fill: white;
        }

        #video-method:checked ~ #c-m-exception-radio-button-2 {
            background-color: #858AD4;
        }

        #video-method:checked ~ #c-m-exception-radio-button-2 span {
            color: white;
        }

        #chat-method:checked ~ #c-m-exception-radio-button-3 svg path {
            stroke: white;
        }

        #chat-method:checked ~ #c-m-exception-radio-button-3 {
            background-color: #858AD4;
        }

        #chat-method:checked ~ #c-m-exception-radio-button-3 span {
            color: white;
        }
