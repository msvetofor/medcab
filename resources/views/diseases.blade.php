        ...
        <div class="container">
            <div class="content_space">
                ...
                <div class="buttons_line">
                    <a href="{{ route('create_disease') }}" class="create_button">
                ...
                @if($diseases->isEmpty())
                    <div class="empty">В настоящее время у вас нет истории болезней</div>
                @else
                    <table class="table">
                        <thead>
                        <tr>
                        ...
                        @foreach($diseases as $disease)
                            <tr>
                                ...
                                <td>{{ $disease->started_at }}</td>
                                <td>{{ $disease->ended_at }}</td>
