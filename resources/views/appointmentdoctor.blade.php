        ...
        <div class="container">
            <div class="content_space">
                <div class="header">
                    ...
                    <div class="header_title">Запись к специалисту <span>(Найдено специалистов {{ $doctors->count() }})</span></div>
                </div>
